...
INSERT INTO "auth"."users" ("instance_id", "id", "aud", "role", "email", "encrypted_password", "email_confirmed_at", "invited_at", "confirmation_token", "confirmation_sent_at", "recovery_token", "recovery_sent_at", "email_change_token_new", "email_change", "email_change_sent_at", "last_sign_in_at", "raw_app_meta_data", "raw_user_meta_data", "is_super_admin", "created_at", "updated_at", "phone", "phone_confirmed_at", "phone_change", "phone_change_token", "phone_change_sent_at", "email_change_token_current", "email_change_confirm_status", "banned_until", "reauthentication_token", "reauthentication_sent_at", "is_sso_user", "deleted_at", "is_anonymous") VALUES
	('00000000-0000-0000-0000-000000000000', '64c1b2ea-9ed0-4273-8356-b6c156ae9d6a', 'authenticated', 'authenticated', 'test@test.com', '$2a$06$0./BnpfuDJRQDWHH4OfzoOLK.T9omU2ae3muytlEFJHOzmDQVbkmG', '2025-06-18 22:07:58.136313+00', NULL, '', NULL, '', '2025-06-18 22:07:58.136313+00', '', '', NULL, '2025-07-01 23:03:56.427647+00', '{"provider": "email", "providers": ["email"]}', '{}', NULL, '2025-06-18 22:07:58.136313+00', '2025-07-02 04:46:10.265918+00', NULL, NULL, '', '', NULL, '', 0, NULL, '', NULL, false, NULL, false);
...
INSERT INTO "auth"."sessions" ("id", "user_id", "created_at", "updated_at", "factor_id", "aal", "not_after", "refreshed_at", "user_agent", "ip", "tag") VALUES
	...
	('0f79b4ad-1d90-4941-acba-5b37b5b715e4', '64c1b2ea-9ed0-4273-8356-b6c156ae9d6a', '2025-07-01 23:03:56.42822+00', '2025-07-02 04:46:10.634786+00', NULL, 'aal1', NULL, '2025-07-02 04:46:10.634685', 'Next.js Middleware', '66.112.231.26', NULL);
...
INSERT INTO "auth"."refresh_tokens" ("instance_id", "id", "token", "user_id", "revoked", "created_at", "updated_at", "parent", "session_id") VALUES
	...
	('00000000-0000-0000-0000-000000000000', 26, 'q5uxumvhfvf6', '64c1b2ea-9ed0-4273-8356-b6c156ae9d6a', false, '2025-07-02 04:46:10.265044+00', '2025-07-02 04:46:10.265044+00', '2v4mftwd66na', '0f79b4ad-1d90-4941-acba-5b37b5b715e4');
...
SELECT pg_catalog.setval('"public"."allergens_id_seq"', 1963, true);
...
SELECT pg_catalog.setval('"public"."food_item_id_seq"', 1963, true);
...
SELECT pg_catalog.setval('"public"."menu_category_id_seq"', 289, true);
...
SELECT pg_catalog.setval('"public"."nutrition_id_seq"', 1963, true);
