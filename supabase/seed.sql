...
INSERT INTO "auth"."sessions" ("id", "user_id", "created_at", "updated_at", "factor_id", "aal", "not_after", "refreshed_at", "user_agent", "ip", "tag") VALUES
	...
	('5e6bc396-db77-42b9-91ee-de4ae6473c0c', '64c1b2ea-9ed0-4273-8356-b6c156ae9d6a', '2025-07-02 17:37:31.587356+00', '2025-07-12 21:49:17.159548+00', NULL, 'aal1', NULL, '2025-07-12 21:49:17.159508', 'Next.js Middleware', '192.168.65.1', NULL);
...
INSERT INTO "auth"."refresh_tokens" ("instance_id", "id", "token", "user_id", "revoked", "created_at", "updated_at", "parent", "session_id") VALUES
	...
	('00000000-0000-0000-0000-000000000000', 43, 'gihptunzkwna', '64c1b2ea-9ed0-4273-8356-b6c156ae9d6a', false, '2025-07-12 21:49:17.125818+00', '2025-07-12 21:49:17.125818+00', 'wxpbmnsamvjk', '5e6bc396-db77-42b9-91ee-de4ae6473c0c');
...
Make Shake Smart your one-stop shop for pre- and post-gym fuel and a regular destination for when you’re on the go.', '2308 Whitis Ave Austin, TX 78712', 'dc1bae58-29a1-4c1f-829e-d0c3e2ed4479', '{"friday": {"isClosed": false, "timeRanges": [{"open": 1000, "close": 1600}]}, "monday": {"isClosed": false, "timeRanges": [{"open": 1000, "close": 1600}]}, "sunday": {"isClosed": true, "timeRanges": [{"open": 700, "close": 1000}]}, "tuesday": {"isClosed": false, "timeRanges": [{"open": 1000, "close": 1600}]}, "saturday": {"isClosed": true, "timeRanges": [{"open": 700, "close": 1000}]}, "thursday": {"isClosed": true, "timeRanges": [{"open": 1000, "close": 1600}]}, "wednesday": {"isClosed": false, "timeRanges": [{"open": 1000, "close": 1600}]}}', '{"Bevo Pay",Credit/Debit,"Dine In Dollars"}', '{}', 'https://maps.app.goo.gl/', 'https://maps.apple.com/?address=2308%20Whitis%20Ave,%20Austin,%20TX%2078712', 'https://housing.utexas.edu/sites/default/files/styles/utexas_image_style_1800w/public/2022-02/smart.png.webp?itok=YtA0utb9', '2025-06-24 06:36:47.046073+00', '2025-07-12 22:17:06.409+00', false, false, 12, 30.286526708812872, -97.74115325186878),
