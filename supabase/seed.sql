...
INSERT INTO "auth"."users" ("instance_id", "id", "aud", "role", "email", "encrypted_password", "email_confirmed_at", "invited_at", "confirmation_token", "confirmation_sent_at", "recovery_token", "recovery_sent_at", "email_change_token_new", "email_change", "email_change_sent_at", "last_sign_in_at", "raw_app_meta_data", "raw_user_meta_data", "is_super_admin", "created_at", "updated_at", "phone", "phone_confirmed_at", "phone_change", "phone_change_token", "phone_change_sent_at", "email_change_token_current", "email_change_confirm_status", "banned_until", "reauthentication_token", "reauthentication_sent_at", "is_sso_user", "deleted_at", "is_anonymous") VALUES
	('00000000-0000-0000-0000-000000000000', '64c1b2ea-9ed0-4273-8356-b6c156ae9d6a', 'authenticated', 'authenticated', 'test@test.com', '$2a$06$0./BnpfuDJRQDWHH4OfzoOLK.T9omU2ae3muytlEFJHOzmDQVbkmG', '2025-06-18 22:07:58.136313+00', NULL, '', NULL, '', '2025-06-18 22:07:58.136313+00', '', '', NULL, '2025-06-19 20:36:28.843591+00', '{"provider": "email", "providers": ["email"]}', '{}', NULL, '2025-06-18 22:07:58.136313+00', '2025-06-20 17:42:50.602456+00', NULL, NULL, '', '', NULL, '', 0, NULL, '', NULL, false, NULL, false);
...
INSERT INTO "public"."location_type" ("id", "name", "created_at", "updated_at") VALUES
	('20be80f1-7e87-424e-a7b8-801c80aca477', 'Dining Hall', '2025-06-19 06:02:38.275971+00', '2025-06-19 06:02:38.275971+00'),
	('dc1bae58-29a1-4c1f-829e-d0c3e2ed4479', 'Restaurant', '2025-06-19 06:02:38.275971+00', '2025-06-19 06:02:38.275971+00'),
	('131bb0cb-a083-40e2-bbe2-4bc6044dd8a7', 'Convenience Store', '2025-06-19 06:02:38.275971+00', '2025-06-19 06:02:38.275971+00'),
	('1193411e-6aba-4941-a611-fc9eb7546757', 'Coffee Shop', '2025-06-19 06:02:38.275971+00', '2025-06-19 06:02:38.275971+00');
...
INSERT INTO "public"."location" ("id", "name", "colloquial_name", "description", "address", "type_id", "regular_service_hours", "methods_of_payment", "meal_times", "google_maps_link", "apple_maps_link", "image", "created_at", "updated_at") VALUES
...
Jester City Market has all your convenience store needs including school supplies, snacks and other goods. Stop in to see all we have to offer.', '201 E 21st St Austin, TX 78705', '131bb0cb-a083-40e2-bbe2-4bc6044dd8a7', '{"friday": {"isClosed": false, "timeRanges": [{"open": 1000, "close": 2200}]}, "monday": {"isClosed": false, "timeRanges": [{"open": 1000, "close": 2300}]}, "sunday": {"isClosed": false, "timeRanges": [{"open": 1200, "close": 2300}]}, "tuesday": {"isClosed": false, "timeRanges": [{"open": 1000, "close": 2300}]}, "saturday": {"isClosed": false, "timeRanges": [{"open": 1200, "close": 2000}]}, "thursday": {"isClosed": false, "timeRanges": [{"open": 1000, "close": 2300}]}, "wednesday": {"isClosed": false, "timeRanges": [{"open": 1000, "close": 2300}]}}', '{"Bevo Pay",Credit/Debit,Cash,"Dine In Dollars"}', '{"{\"name\": \"Lunch\", \"end_time\": 1800, \"start_time\": 1000}","{\"name\": \"Dinner\", \"end_time\": 2200, \"start_time\": 1900}"}', 'https://maps.app.goo.gl/PrsZA1x88GUqdhhx6', 'https://maps.apple.com/?address=201%20E%2021st%20St,%20Austin,%20TX%20%2078705,%20United%20States&auid=8818684010108699137&ll=30.282849,-97.736878&lsp=9902&q=Jester%20City%20Market', '', '2025-06-20 17:48:09.272069+00', '2025-06-20 17:48:09.272069+00'),
...
SELECT pg_catalog.setval('"public"."allergens_id_seq"', 422, true);
...
SELECT pg_catalog.setval('"public"."food_item_id_seq"', 422, true);
...
SELECT pg_catalog.setval('"public"."menu_category_id_seq"', 64, true);
...
SELECT pg_catalog.setval('"public"."nutrition_id_seq"', 422, true);
